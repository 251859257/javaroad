...
<?php
	...
	echo'
	<div class="container-center row" style="width:100%;">
		<!--BEGIN #content-->
		<div id="content">
    ...
    foreach($cats as $the_cat){
        ...
        if(!empty($posts)){
			$i++;
            echo'
            <div class="col-sm-12 col-md-4 content-box content-box-1" style="border-radius: 5px;padding-top: 20px;">
				<h2 style="color:#3DB6B9;font-size: 26px;">'.$the_cat->name.'</h2><a href="'.get_category_link($the_cat).'" class="read-more btn t4p-button">点击进入</a>
			</div>
			'; 
			if($i%3 == 0){
				echo'
