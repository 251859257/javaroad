...
<html <?php language_attributes(); ?>>
    ...
    <head>
		...
		<meta property="qc:admins" content="11513721266216127146367" />
        <?php wp_head(); ?>
		<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/fonts/icon/iconfont.css">
        <!--[if lt IE 9]>
